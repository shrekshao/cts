...
**/import { assert, unreachable } from '../../../common/framework/util/util.js';import { kUncompressedTextureFormatInfo } from
...
export let TexelComponent;(function (TexelComponent) {TexelComponent["R"] = "R";TexelComponent["G"] = "G";TexelComponent["B"] = "B";TexelComponent["A"] = "A";TexelComponent["Depth"] = "Depth";TexelComponent["Stencil"] = "Stencil";})(TexelComponent || (TexelComponent = {}));var
...
(function (TexelWriteType) {TexelWriteType[TexelWriteType["Sint"] = 0] = "Sint";TexelWriteType[TexelWriteType["Uint"] = 1] = "Uint";TexelWriteType[TexelWriteType["Float"] = 2] = "Float";})(TexelWriteType || (TexelWriteType = {}));
...
class TexelDataRepresentationImpl {
  ...
  componentInfo,
  sRGB)
  {this.format = format;this.componentOrder = componentOrder;this.componentInfo = componentInfo;this.sRGB = sRGB;}
